...
from hunter.trade.ccxt.base.exchange import Exchange
import json
from hunter.trade.ccxt.base.errors import ExchangeError
from hunter.trade.ccxt.base.errors import AuthenticationError
from hunter.trade.ccxt.base.errors import PermissionDenied
from hunter.trade.ccxt.base.errors import OrderNotFound
from hunter.trade.ccxt.base.errors import DDoSProtection


class test_bitmex (Exchange):

    def describe(self):
        return self.deep_extend(super(test_bitmex, self).describe(), {
            'id': 'test_bitmex',
            'name': 'test_BitMEX',
    ...
    def fetch_my_trades(self, symbol=None, limit=None, since=None, params={"reverse": True}):
        self.load_markets()
        market = None
        request = {}
        if symbol is not None:
    ...
    def set_leverage(self, symbol, leverage, params={}):
        ...
        response = self.privatePostPositionLeverage(self.extend(request, params))
        return response
    ...
    def add_margin(self, symbol, amount, params={}):
        ...
        response = self.privatePostPositionTransferMargin(self.extend(request, params))
        return response
