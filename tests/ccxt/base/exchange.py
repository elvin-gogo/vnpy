...
from hunter.trade.ccxt.base.errors import ExchangeError
from hunter.trade.ccxt.base.errors import NetworkError
from hunter.trade.ccxt.base.errors import NotSupported
from hunter.trade.ccxt.base.errors import AuthenticationError
from hunter.trade.ccxt.base.errors import DDoSProtection
from hunter.trade.ccxt.base.errors import RequestTimeout
from hunter.trade.ccxt.base.errors import ExchangeNotAvailable
from hunter.trade.ccxt.base.errors import InvalidAddress
# -----------------------------------------------------------------------------

from hunter.trade.ccxt.base.decimal_to_precision import decimal_to_precision
from hunter.trade.ccxt.base.decimal_to_precision import DECIMAL_PLACES, TRUNCATE, ROUND
...
if __name__ == '__main__':
    a = Exchange.parse8601('2018-10-07T07:14:48.846Z')
    print(a)