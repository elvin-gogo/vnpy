...
if __name__ == '__main__':
    ...
    # 设置回测用的数据起始日期
    engine.setStartDate('20181026')

    # 设置产品相关参数
    engine.setSlippage(0)     # 股指1跳
    engine.setRate(0.1/10000)   # 万0.3
    engine.setSize(25)         # 股指合约大小
    engine.setPriceTick(0.01)    # 股指最小价格变动
    
    # 设置使用的历史数据库
    engine.setDatabase(MINUTE_DB_NAME, 'BTC/USD.BITMEX')
    ...
    table={}
    arryList=[]
    keyItem=[u'第一笔交易:',u'最后一笔交易:',u'总交易次数:',u'总盈亏:',u'最大回撤:',u'平均每笔盈利:',u'平均每笔滑点:',u'平均每笔佣金:',u'胜率:',u'盈利交易平均值:',
             u'亏损交易平均值:',u'盈亏比:']
    valueItem=[]
    ...
    # 保存默认设置
    abc=BackManager(main, './trade.csv', '5m')
