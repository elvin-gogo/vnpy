...
class TestBitmexWebsocketApi(WebsocketClient):
    ...
    def subscribeMarketData(self, symbol):
        ...
        tick.symbol = symbol
        tick.exchange = EXCHANGE_TEST_BITMEX
    ...
    def onTrade(self, d):
        ...
        trade.exchange = EXCHANGE_TEST_BITMEX
    ...
    def onOrder(self, d):
        ...
        if sysID in self.orderDict:
            ...
            order.exchange = EXCHANGE_TEST_BITMEX
    ...
    def onPosition(self, d):
        ...
        pos.symbol = d['symbol']
        pos.exchange = EXCHANGE_TEST_BITMEX
    ...
    def onContract(self, d):
        ...
        contract.exchange = EXCHANGE_TEST_BITMEX
