...
class Crosshair(QtCore.QObject):
    ...
    def __init__(self,parent,master):
        ...
        self.__textIndicators=pg.TextItem('',anchor=(1,0))
    ...
    def plotInfo(self,xAxis):        
        ...
        if self.master.indicatorsFunManage:
            x = int(xAxis)
            indicatorsHtml=self.master.indicatorsFunManage.getIndicatorsHtml("mainfigure",x)
            if indicatorsHtml is not None:
